...
export default function Error({ error, reset }) {
  return (
    <div className='w-full bg-[#051a39] min-h-screen flex p-10 justify-center text-center'>
      <div className='flex flex-col items-center'>
        <Image src="/error.gif" width={300} height={300} alt="" />
        <h1 className='text-5xl text-red-400 p-3'>OOPs!</h1>
        <h2 className='text text-blue-200 p-3'>An Error Occured: "{error.message}"</h2>

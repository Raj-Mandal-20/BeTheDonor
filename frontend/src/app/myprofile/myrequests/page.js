            ...
            <div className='w-[85%] min-h-screen flex justify-center items-center'>
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <div className='w-full p-12 flex flex-wrap gap-4'>
                        <h1 className='text-lg micro:text-sm text-white'>{myRequestsResponse.statusCode}</h1>
                        <h1 className='text-lg micro:text-sm text-gray-400'>|</h1>
                        <h1 className='text-lg micro:text-sm text-white'>{myRequestsResponse.message}</h1>
                    </div>
                </div>
            </div>
        );
